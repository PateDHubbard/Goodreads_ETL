...
class GoodreadsETL:
    ...
    def create_soup_from_html(self, html_file_name):
        with open(html_file_name) as fp:
            return BeautifulSoup(fp, 'html.parser')
        
    def create_soup_using_selenium(self):
        download_path = "/"
        ...
        driver.find_element(By.ID, "ap_email").send_keys(os.environ.get("username"))
    ...
    def parse_soup_to_df(self, soup):
    ...
    def create_shelves_csv(self, df):
    ...
    def create_dates_read_csv(self, df):
